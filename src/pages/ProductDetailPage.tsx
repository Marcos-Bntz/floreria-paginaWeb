...
export const ProductDetailPage: React.FC = () => {
  ...
  const relatedProducts = products.filter(p => 
    p.id !== id && (p.category === product?.category || p.occasion === product?.occasion)
  ).slice(0, 4);
    ...
    <Layout>
      <div className="container-custom py-8">
        ...
        <nav className="flex mb-8 text-sm">
          ...
          <Link to="/catalogo" className="text-gray-500 hover:text-primary">Catálogo</Link>
          <ChevronRight size={16} className="mx-2 text-gray-400" />
          <Link to={`/catalogo?categoria=${product.category}`} className="text-gray-500 hover:text-primary capitalize">
            {product.category}
          </Link>
          <ChevronRight size={16} className="mx-2 text-gray-400" />
            ...
            <div className="mb-6">
              ...
              <div className="p-4 border border-gray-200 rounded-lg bg-gray-50">
                <div className="flex items-start mb-3">
                  <Truck className="text-primary mt-0.5 mr-2 flex-shrink-0" size={20} />
                  <div>
                    <h4 className="font-medium text-gray-800">Envío a domicilio</h4>
                    <p className="text-sm text-gray-600">Entrega estimada: 24-48 horas</p>
                  </div>
                </div>
                
                <div className="flex items-start">
                  <Check className="text-primary mt-0.5 mr-2 flex-shrink-0" size={20} />
                  <div>
                    <h4 className="font-medium text-gray-800">Satisfacción garantizada</h4>
                    <p className="text-sm text-gray-600">Flores frescas con garantía de 7 días</p>
                  </div>
                </div>
              </div>
            </div>
