          ...
          {filterOptions.categories.map(category => (
            <label key={category} className="flex items-center cursor-pointer">
              <input
                ...
                onChange={() => setFilter('category', filters.category === category ? undefined : category)}
          ...
          {filterOptions.styles.map(style => (
            <label key={style} className="flex items-center cursor-pointer">
              <input
                ...
                onChange={() => setFilter('style', filters.style === style ? undefined : style)}
                className="form-radio text-primary focus:ring-primary"
              />
          ...
          {filterOptions.occasions.map(occasion => (
            <label key={occasion} className="flex items-center cursor-pointer">
              <input
                ...
                onChange={() => setFilter('occasion', filters.occasion === occasion ? undefined : occasion)}
                className="form-radio text-primary focus:ring-primary"
              />
