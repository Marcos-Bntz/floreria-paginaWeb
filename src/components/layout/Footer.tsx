...
import { Flower, Mail, Phone, MapPin, Instagram, Facebook, Twitter } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 leading-relaxed">
              Llevando belleza y alegría a cada ocasión con nuestros arreglos florales artesanales.
            </p>
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h3 className="font-heading text-lg font-semibold">Enlaces Rápidos</h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/catalogo?categoria=flores" className="text-gray-300 hover:text-white transition-colors">
                  Flores
                </Link>
              </li>
              <li>
                <Link to="/catalogo?categoria=plantas" className="text-gray-300 hover:text-white transition-colors">
                  Plantas & Árboles
                </Link>
              </li>
              <li>
                <Link to="/catalogo?categoria=regalos" className="text-gray-300 hover:text-white transition-colors">
                  Regalos
                </Link>
              </li>
            </ul>
          ...
          {/* Customer Service */}
          <div className="space-y-4">
            <h3 className="font-heading text-lg font-semibold">Atención al Cliente</h3>
            <ul className="space-y-2">
              <li>
